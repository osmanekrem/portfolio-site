      ...
      <h1 className="text-3xl font-bold">Who am I? 🚀</h1>
        <div className="flex flex-col gap-y-4 w-full">
          <p>
            ...
            with code from my middle school days. It all started with Python
            (the language, not the snake, although both can be quite
            enthralling). My journey through Java and other languages led me to
            the vibrant world of frontend development during my high school
            years.
          </p>
          <p>
