    ...
    <div className="w-full h-full flex mb-10 mt-2 items-center justify-center">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-5">
        ...
        <div className="flex flex-col items-center lg:items-start gap-y-2 h-full">
          <h1 className=" font-bold text-4xl tracking-tight text-center">Hi 👋, I&apos;m <span className="whitespace-nowrap text-primary">Osman Ekrem</span></h1>
          ...
          <ul className="flex flex-col mt-1.5 gap-y-2 items-center lg:items-start text-sm lg:text-base">
            ...
            <li>📍 Türkiye</li>
            <li>
              <Link href="mailto:korkmazosmanekrem@gmail.com">📧 korkmazosmanekrem@gmail.com</Link>
            </li>
          </ul>
        </div>
      </div>
