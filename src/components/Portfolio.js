  ...
  return (
    <div id='portfolio' className='portfolio'>
        <div className='portfolio-header'>
            <h1>Portfolio</h1>
            <ul>
                <li onClick={() => setActiveTab("featured")} className={activeTab === "featured" ? "active" : ""}>Featured</li>
                <li onClick={() => setActiveTab("web")} className={activeTab === "web" ? "active" : ""}>Web</li>
                <li onClick={() => setActiveTab("design")} className={activeTab === "design" ? "active" : ""}>Design</li>
            </ul>
        </div>
            ...
            {content[activeTab].map(item => (
                <div className='portfolio-item' key={item.id}>
                    ...
                    <div className='portfolio-item-links'>
                        {item.link && <a className='demo-link' href={item.link} rel="noreferrer" target='_blank'>Live</a>}
